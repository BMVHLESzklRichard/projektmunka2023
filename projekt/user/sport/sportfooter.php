...
{
    $elsohir .= "<div class=\"footermagas\"><a href=\"../felhasznaloiFelulet/hirek/{$sor["alias"]}\"><img src=\"../../kepek/f1cars2023/{$sor["shownPicture"]}\" alt=\"MC\" style=\"width:100%;\"><div><p>{$sor["title"]}</p></div></a></div>";
}
$elsohir .="</div>";
