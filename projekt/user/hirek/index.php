...
if(mysqli_num_rows($eredmeny) == 1)
{
            ...
            $sql2 = "SELECT hozzaszolasok.id,hozzaszolasok.kommentszoveg,bejelentkezettek.name,bejelentkezettek.foto,hozzaszolasok.kommentdatum FROM `hozzaszolasok` inner join hirek on hirek.id = hozzaszolasok.hirid inner join bejelentkezettek on bejelentkezettek.id = hozzaszolasok.accid WHERE hirek.alias = '{$alias}'";
        $eredmeny2 = mysqli_query($dbconn,$sql2);
