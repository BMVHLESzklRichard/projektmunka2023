...
from news where  status = 1 and mainNews = 1 order by creationDate desc";
...
<head>
  ...
  -webkit-box-sizing: border-box;
    ...
    <title>RNMotorsport-Fő cikkek</title>
    <style>
:root
{
    --primarycolor: #4aa0be;
    --secondarycolor: #ff83f5;
    --ferrariyellow: black;
    --helmetinner: #e31b04;
    --helmetouter: black;
    --wheelcover: #4aa0be;
...
body {
  ...
  background: linear-gradient(rgb(123, 178, 255),rgb(41, 68, 125),grey);
}
    </style>
</head>

<body id="mainNewsBody">
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.min.js"
        ...
        crossorigin="anonymous"></script>
        <script>
        let mainNewsBody = document.getElementById("mainNewsBody");
        mainNewsBody.innerHTML = `<div class="redlamps">
    ...
    <svg viewBox="0 0 178 40" width="586" height="170">
                ...
                <g transform="translate(10 24.125)">
                    ...
                    <defs>
                        <linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="100%">
                            <stop offset="40%" style="stop-color:var(--secondarycolor)" />
                            <stop offset="41%" style="stop-color:black" />
                            <stop offset="59%" style="stop-color:black" />
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    mainNewsBody.style.display = "block";
                    mainNewsBody.style.background = "white";
                    mainNewsBody.innerHTML = `
<nav>
    <div class="navbar">
