...
if(isset($_POST["rendben"]))
{
    ...
    $mime = array("image/gif", "image/png", "image/jpg", "image/jpeg");
	 ...
	 else
	 {
		...
		$sql = "INSERT INTO `hirek`(`alias`, `cim`, `tartalom`, `letrehozas`, `fohir`, `leiras`, `statusz`, `megjelenokep`, `hiriroid`) VALUES ('{$alias}','{$cim}','{$tartalom}',Now(),'{$fohir}','{$leiras}','{$statusz}','{$foto}', '{$hiriroid}')";
