<div class="displéj" id="adat">
  <div class="useradatok">
        ...
        <div class="belsokep">
          ...
          <div class="nembaj">
            ...
            <div class="bsszoveg">
              ...
              ?>
              <a href="changename.php"><i class="material-icons lila">mode_edit</i></a>
            </div>
          </div>
        ...
        <div class="beallitasokkis">
          ...
          <div class="nyelvcs">
            ...
            <button onclick="Changelang()">
              <span class="hu"><img src="../kepek/uk-flag.gif" alt="hu" class="langkep"></span>
              <span class="en"><img src="../kepek/hu-flag.gif" alt="en" class="langkep"></span>
            </button>
          </div>
        </div>
    ...
    <div class="bezarkep" onclick="userjelen()">
      <img src="../kepek/iksz.png" alt="x">
    </div>
  </div>
