...
$sql = "SELECT id,email,username,password,name,permission,statusz,foto FROM `bejelentkezettek`";
...
$tablazat = "<table><thead>
    ...
    {
      $statusz =  ($sor["statusz"] == '1' ? "Aktív felhasználó": "Inaktív felhasználó");
      $permission = ($sor["permission"] ==0?"user":"admin");
