...
while ($sor4 = mysqli_fetch_assoc($eredmeny5)) {
    $tabellamenu .= "<div class=\"hover-img2 masodik\"><img src=\"../../kepek/pilotakepek/{$sor4["pilotafoto"]}\"><figcaption>{$sor4["pilotaknev"]} {$sor4["pilotavnev"]}<br>{$sor4["pilotapont"]} <span class=\"hu\">pont</span>
...
while ($sor4 = mysqli_fetch_assoc($eredmeny4)) {
    $tabellamenu .= "<div class=\" hover-img2 elso\"><img src=\"../../kepek/pilotakepek/{$sor4["pilotafoto"]}\"><figcaption>{$sor4["pilotaknev"]} {$sor4["pilotavnev"]}<br>{$sor4["pilotapont"]} <span class=\"hu\">pont</span>
...
while ($sor4 = mysqli_fetch_assoc($eredmeny6)) {
    $tabellamenu .= "<div class=\"hover-img2 harmadik\"><img src=\"../../kepek/pilotakepek/{$sor4["pilotafoto"]}\"><figcaption>{$sor4["pilotaknev"]} {$sor4["pilotavnev"]}<br>{$sor4["pilotapont"]} <span class=\"hu\">pont</span>
    <span class=\"en\">points</span></figcaption></div>";
}
...
while ($sor4 = mysqli_fetch_assoc($eredmeny7)) {
    $tabellamenu .= "<li><div>{$sor4["pilotaknev"]} {$sor4["pilotavnev"]}</div> <div style=\"display:flex;gap:5px;\">{$sor4["pilotapont"]} <span class=\"hu\">pont</span>
...
while ($sor4 = mysqli_fetch_assoc($eredmeny4)) {
    $csapattab .= "<div class=\"hover-img2 elso\"><img src=\"../../kepek/kocsirajzok/{$sor4["autofoto"]}\"><figcaption>{$sor4["csapatnev"]}<br>{$sor4["csapatpont"]} <span class=\"hu\">pont</span>
    <span class=\"en\">points</span></figcaption></div>";
}
...
while ($sor4 = mysqli_fetch_assoc($eredmeny5)) {
    $csapattab .= "<div class=\"hover-img2 masodik\"><img src=\"../../kepek/kocsirajzok/{$sor4["autofoto"]}\"><figcaption>{$sor4["csapatnev"]}<br>{$sor4["csapatpont"]} <span class=\"hu\">pont</span>
    <span class=\"en\">points</span></figcaption></div>";
}
...
while ($sor4 = mysqli_fetch_assoc($eredmeny6)) {
    $csapattab .= "<div class=\"hover-img2 harmadik\"><img src=\"../../kepek/kocsirajzok/{$sor4["autofoto"]}\"><figcaption>{$sor4["csapatnev"]}<br>{$sor4["csapatpont"]} <span class=\"hu\">pont</span>
    <span class=\"en\">points</span></figcaption></div>";
}
...
while ($sor4 = mysqli_fetch_assoc($eredmeny7)) {
    $csapattab .= "<li><div>{$sor4["csapatnev"]}</div> <div style=\"display:flex;gap:5px;\">{$sor4["csapatpont"]} <span class=\"hu\">pont</span>
    <span class=\"en\">points</span></div></li>";
}
$csapattab .= "</ul></div>";
...
if (mysqli_num_rows($eredmeny) == 1) {
 ...
 <input type=\"submit\" id=\"new\" name=\"new\" value=\"OK\"></p>
       ...
       if(isset($_POST['new']))
       {
           ...
           $sqlvane  = "select accid, kommentszoveg from hozzaszolasok where accid='{$bejelentid}' and kommentszoveg='{$szoveg}' and hirid='{$id}'";
