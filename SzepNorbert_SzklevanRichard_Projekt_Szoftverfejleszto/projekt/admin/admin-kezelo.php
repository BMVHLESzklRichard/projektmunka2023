...
$tablazat = "<table><thead>
    ...
    {
      $engedelyadas =  ($sor["status"] == '0' ? "<i class=\"material-icons  piros\" onclick=\"perback({$sor["id"]});\">done</i></a>": "<i class=\"material-icons  piros\" onclick=\"perdelete({$sor["id"]});\">delete</i></a>");
