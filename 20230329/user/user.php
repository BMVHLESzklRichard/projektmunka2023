...
<a href=\"hirek/{$sor["alias"]}\"><img src=\"../kepek/f1cars2023/{$sor["megjelenőkép"]}\" class=\"d-block w-100\" alt=\"...\"></a>
...
$sql = "SELECT id,alias,megjelenőkép,cím,leírás
from hirek where főhír = 1 and státusz = 1 order by létrehozás desc limit 1,3";
...
$sql1 = "SELECT id,alias,megjelenőkép,cím
from hirek where főhír = 0 and státusz = 1 order by létrehozás desc limit 12";
...
{
$kismenu .= "<div class=\"magas hover-img\">\n<a href=\"hirek/{$sor["alias"]}\"><img src=\"../kepek/f1cars2023/{$sor["megjelenőkép"]}\" alt=\"MC\" style=\"width:100%;\"><figcaption>{$sor["cím"]}</figcaption></a>\n</div>\n";
}
$kismenu .= "  
...
while($sor9 = mysqli_fetch_assoc($eredmeny9))
{
    switch($sor9["csapathelyezés"])
    {
        case '1':
            ...
            $csapathurkak .= "<div class=\"panel active\" style=\"background-image: url(../kepek/csapatkepek/{$sor9["csapatfotó"]});\">
            <p class=\"h3\">{$sor9["csapatnév"]}</p>
            <p></p>
            <div class=\"lista\">
                <p class=\"listaszoveg\"><span class=\"hu\">Csapatfőnök: </span>
                <span class=\"en\">Team Principal: </span>{$sor9["csapatfőnök"]}</p>
                <p class=\"listaszoveg\"><span class=\"hu\">Pilóták:</span>
                <span class=\"en\">Drivers:</span> ";

                $sql11 = "SELECT pilotak.pilótavezetéknév,pilotak.pilótakeresztnév FROM teljescsapat inner join csapatok on teljescsapat.csapatid = csapatok.id inner join pilotak on teljescsapat.pilotaid = pilotak.id where csapatid = {$sor9["csapatid"]}";

                $eredmeny11 = mysqli_query($dbconn,$sql11);
                while($sor11 = mysqli_fetch_assoc($eredmeny11))
                {
                    $csapathurkak.="{$sor11["pilótakeresztnév"]} {$sor11["pilótavezetéknév"]}, ";
                }
               $csapathurkak.=" </p><p class=\"listaszoveg\"><span class=\"hu\">Konstruktőri bajnoki címek:</span>
               <span class=\"en\">Constructor's championships:</span> {$sor9["csapatbajnokicím"]} <span class=\"hu\">db</span>
               <span class=\"en\">x</span></p>
                <p class=\"listaszoveg\"><span class=\"hu\">Győzelmek: </span>
                <span class=\"en\">Wins: </span> {$sor9["csapatgyőzelem"]} <span class=\"hu\">db</span>
                <span class=\"en\">x</span></p>
                <p class=\"listaszoveg\"><span class=\"hu\">Dobogós helyezések: </span>
                <span class=\"en\">Podiums: </span>{$sor9["csapatdobogó"]} <span class=\"hu\">db</span>
                <span class=\"en\">x</span></p>
                ...
                <span class=\"en\">Previous year result: </span> {$sor9["csapathelyezés"]}<span class=\"hu\">. hely</span>
        ...
        while($sor10 = mysqli_fetch_assoc($eredmeny10))
        {
            ...
            $csapathurkak .= "<div class=\"panel\" style=\"background-image: url(../kepek/csapatkepek/{$sor10["csapatfotó"]});\">
            <p class=\"h3\">{$sor10["csapatnév"]}</p>
            <p></p>
            <div class=\"lista\">
                <p class=\"listaszoveg\"><span class=\"hu\">Csapatfőnök</span>
                <span class=\"en\">Team Principal</span>{$sor10["csapatfőnök"]}</p>
                <p class=\"listaszoveg\"><span class=\"hu\">Pilóták:</span>
                <span class=\"en\">Drivers:</span> ";

                $sql11 = "SELECT pilotak.pilótavezetéknév,pilotak.pilótakeresztnév FROM teljescsapat inner join csapatok on teljescsapat.csapatid = csapatok.id inner join pilotak on teljescsapat.pilotaid = pilotak.id where csapatid = {$sor10["csapatid"]}";
               ...
               $csapathurkak.=" </p><p class=\"listaszoveg\"><span class=\"hu\">Konstruktőri bajnoki címek:</span>
               <span class=\"en\">Constructor's championships:</span> {$sor10["csapatbajnokicím"]} <span class=\"hu\">db</span>
               <span class=\"en\">x</span></p>
                <p class=\"listaszoveg\"><span class=\"hu\">Győzelmek: </span>
                <span class=\"en\">Wins: </span> {$sor10["csapatgyőzelem"]} <span class=\"hu\">db</span>
                <span class=\"en\">x</span></p>
                <p class=\"listaszoveg\"><span class=\"hu\">Dobogós helyezések: </span>
                <span class=\"en\">Podiums: </span>{$sor10["csapatdobogó"]} <span class=\"hu\">db</span>
                <span class=\"en\">x</span></p>
                <p class=\"listaszoveg\"><span class=\"hu\">Eddigi szezonpontok: </span>
                <span class=\"en\">Points so far: </span>{$sor10["csapatpont"]} <span class=\"hu\">pont</span>
                <span class=\"en\">points</span></p>
                <p class=\"listaszoveg\"><span class=\"hu\">Tavalyi helyezés: </span>
                <span class=\"en\">Previous year result: </span> {$sor10["csapathelyezés"]}<span class=\"hu\">. hely</span>
                <span class=\"en\">{$moge}</p>
            </div>
      </div>";
        }
