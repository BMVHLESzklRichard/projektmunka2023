...
$szam= 1;
  ...
  Sorry, your browser does not support inline SVG.  
          ...
          <div style=\"border: 5px solid {$sor["csapatszín"]};background-color: {$sor["csapatszín"]}; display: flex; align-items: flex-end;\">
            <div class=\"card_image csapatkartya\"><img src=\"../kepek/kocsirajzok/{$sor["autófotó"]}\">
            <div class=\"card_content\">
            <h2 class=\"card_title\">{$sor["csapatnév"]}</h2>
            <ul>
