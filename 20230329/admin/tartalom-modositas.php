	...
	//változók ellenőrzés
	 ...
	 else
	 {
        ...
        $id= (int)$_GET['id'];
		 ...
		 $sql = "UPDATE `hirek` SET `alias`='{$alias}',`cím`='{$cim}',`tartalom`='{$tartalom}',`módosítás`=NOW(),`leírás`='{$leiras}',`státusz`='{$statusz}', `megjelenőkép`='{$foto}',`főhír`='{$fohir}' WHERE `id` = {$id}";
