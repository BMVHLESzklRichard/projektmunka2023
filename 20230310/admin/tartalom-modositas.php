	...
	//változók ellenőrzés
	 ...
	 else
	 {
        ...
        $id= (int)$_GET['id'];
		 ...
		 $sql = "UPDATE `hirek` SET `alias`='{$alias}',`cim`='{$cim}',`tartalom`='{$tartalom}',`modositas`=NOW(),`leiras`='{$leiras}',`kulcsszavak`='Fejlesztésalatt',`statusz`='{$statusz}', `megjelenokep`='{$foto}',`fohir`='{$fohir}' WHERE `id` = {$id}";
...
<form action="" method="post" enctype="multipart/form-data">
	...
	<p>
		...
		<textarea name="tartalom" id="tartalom"  style="min-height:300px">$tartalom</textarea>
	</p>
	<p>
