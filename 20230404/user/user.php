...
<body>
    ...
    <div class="fogrid">
        ...
        <?php echo $kismenu;  ?>
        <div class="futamok">
            <div class="futam "><a href="https://www.youtube.com/watch?v=FExS3lFEwqc" target="_blank"><img src="../kepek/videokeps/aus2023gp.jpg" alt=""></a></div>
            <div class="futam "><a href="https://www.youtube.com/watch?v=NJ_sGE1DUQE" target="_blank"><img src="../kepek/videokeps/aus2023quali.jpg" alt=""></a></div>
    ...
    while ($sor9 = mysqli_fetch_assoc($eredmeny9)) {
        ...
        $csapathurkak .= " </p>
        <span class=\"hu\">
        <h5>A 2023-as szezonig elért eredmények:</h5></span><span class=\"en\">
        <h5>Results before the start of the 2023 season:</h5></span><p class=\"listaszoveg\"><span class=\"hu\">Konstruktőri bajnoki címek:</span>
