...
$sql = "SELECT racePic, raceName, raceDate, fpOne, fpTwo, fpThree, quali, sprint,id,countryFlag FROM races";
...
while($sor = mysqli_fetch_assoc($eredmeny))
{
    ...
    <span class=\"en\">FP2: </span></b>".date("Y m d - H:i",strtotime($sor["fpTwo"]))."</li>
