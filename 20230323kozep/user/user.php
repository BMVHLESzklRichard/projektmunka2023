        ...
        case '1':
            ...
            <div class=\"lista\">
               ...
               <span class=\"en\">x</span></p>
                ...
                <span class=\"en\">Previous year result: </span> {$sor9["csapathelyezes"]}<span class=\"hu\">. hely</span>
        ...
        while($sor10 = mysqli_fetch_assoc($eredmeny10))
        {
            ...
            <div class=\"lista\">
               ...
               <span class=\"en\">x</span></p>
                ...
                <span class=\"en\">points</span></p>
                <p class=\"listaszoveg\"><span class=\"hu\">Tavalyi helyezés: </span>
                <span class=\"en\">Previous year result: </span> {$sor10["csapathelyezes"]}<span class=\"hu\">. hely</span>
                <span class=\"en\">{$moge}</p>
            </div>
      </div>";
        }
