...
$sql = "SELECT futamkep, futamnev, futamidopont, edzesegy, edzesketto, edzesharom, idomero, sprint,id FROM futamok";
...
<div class=\"carousel-box\">
    <div class=\"title\">{$sor["futamnev"]}</div>
    <div class=\"num\"><span class=\"hu\">Futam:</span>
    <span class=\"en\">Race: </span>{$sor["futamidopont"]}</div>
    <img id=\"kep{$sor["id"]}\" src=\"{$sor["futamkep"]}\"/>
    <ul>
