<footer class="footer">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-6">
                <div class="oszlop2">
                    ...
                    <svg viewBox="10 0 178 40" width="178" height="40" class="svgg">
        ...
        -->
                ...
                -->
                                    <g id="wheel">
                                        ...
                                        <use href="#circle" fill="black" transform="scale(5)"></use>
                                        <!-- inner shadow -->
                    ...
                    -->
                                        <path fill="none" stroke="white" stroke-width="0.75" stroke-linecap="square" stroke-linejoin="square" stroke-dasharray="20 14 8 5" d="M 0 -7.5 a 7.5 7.5 0 0 1 0 15 a 7.5 7.5 0 0 1 0 -15">
                                        </path>
                                        <!-- outer glow (from a hypothetical light source) -->
                                        <path fill="none" stroke="#fff" stroke-width="0.5" stroke-linecap="round" stroke-linejoin="round" opacity="0.1" stroke-dashoffset="0" d="M -6.5 -6.25 a 10 10 0 0 1 13 0 a 9 9 0 0 0 -13 0">
                                        </path>
                                    </g>
                                </defs>
            ...
            -->
                                <g transform="translate(51.5 11.125)">
                                    <path stroke-width="2" stroke="#1E191A" fill="yellow" d="M 0 0 v -2 a 4.5 4.5 0 0 1 9 0 v 2">
                                    </path>
                ...
                -->
                                    <path fill="#fd7117" stroke="#1E191A" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round" d="M 0 0 v -10 l 35 -13 v 5 l 4 0.5 l 0.5 4.5 h 35.5 l 30 13">
                                    </path>

                                    <!-- wings -->
                                    <g fill="#2a73ae" stroke="#1E191A" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round">
                                    ...
                                    <path fill="black" stroke="#1E191A" stroke-width="2.25" stroke-linejoin="round" d="M 48.125 -6 h -29 v 6 h 29"><!-- .125 to tuck the path behind the rectangle and avoid a pixel disconnect as the svg is scaled -->
                                    </path>
    ...
    -->
                        <g fill="none" stroke-width="1" stroke-linejoin="round" stroke-linecap="round">
                            ...
                            <path class="air" stroke="#E85725" d="M 117 16.85 c -12 0 -12 16 -24 16 h -8"><!-- around (117 29.85) where the right wheel is centered -->
                            </path>
                    ...
                    <svg viewBox="10 0 178 40" width="178" height="40"  class="merga">
    <!-- dash included behind the car
    ! be sure to delay the animation of the path after the dashes on the right side of the car
    -->
    <path
