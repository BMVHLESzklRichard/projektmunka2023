...
body {
  ...
  background: linear-gradient(rgb(57, 57, 80), rgb(79, 79, 79));
}
...
<body id="allNewsBody">
    ...
    <script>
        let allNewsBody = document.getElementById("allNewsBody");
        allNewsBody.innerHTML = `<canvas id="confetti1"></canvas>
        <img src="../../kepek/champagnebottle.png" alt="champagneBottle" id="champagneBottle1" style="display:none">
                   <div class="redlamps">
...
let champagneBottle = document.getElementById("champagneBottle1");
let W = window.innerWidth;
let H = document.getElementById('confetti1').clientHeight;
const canvas = document.getElementById('confetti1');
const context = canvas.getContext("2d");
const maxConfettis = 850;
const particles = [];
...
setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    allNewsBody.style.display = "block";
                    allNewsBody.style.background = "white";
                    allNewsBody.innerHTML = `<nav>
    <div class="navbar">
        ...
        <div class="nav-links" id="navkis">
            ...
            <ul class="links">
                ...
                <li><a href="mellekhirek.php"> <span class="hu">Mellék hírek</span>
                        <span class="en">Other news</span></a></li>
            </ul>
        </div>
