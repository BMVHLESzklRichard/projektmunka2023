...
session_start();
if (isset($_SESSION['belepett']) && $_SESSION['userper'] == "1") {
...
<body class="adminbody">
    ...
    <div class="gridadmin">
        ...
        <div class="griduserfel gridmind hover-img"><a href="../user/felhasznaloiFelulet/user.php"><img src="../kepek/adminkepek/papir.jpg" alt="userfelulet" title="userfelulet"><figcaption>Felhasználói<br>felület</figcaption></a></div>
