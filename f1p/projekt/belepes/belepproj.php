...
if (isset($_POST['ok'])) {
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    if ($row['permission'] == '1') {
      ...
      $log = date("Y-m-d H:i:s") . " Sikeres belépés {$row['name']} ({$email}) által. ({$_SERVER['REMOTE_ADDR']})\n";
      file_put_contents("adminlog.txt", $log, FILE_APPEND);
      ...
      header('Location:../user/choose.html');
    }
  } else {
    ...
    file_put_contents("failedlog.txt", $log, FILE_APPEND);
  }
}
    ...
    <div class="main-container">
      <div class="main">
        <div id="light">
          ...
          <div id="lineh7">
            <img src="../kepek/kocsirajzok/sauberrajz.png" class="kep2">
          </div>
          <div id="lineh8">
          ...
          <div id="lineh10">
            <img src="../kepek/kocsirajzok/rbrajz.png" class="kep2">
          </div>
        </div>
        <header>
          <div class="overlay">
                ...
                <div class="kis">
                  ...
                  <form id="fom" method="post">
                    <div class="belepes">
                      ...
                      <div class="vendeg"><a href="../user/choose.html">Folytatás vendégként!</a></div>
