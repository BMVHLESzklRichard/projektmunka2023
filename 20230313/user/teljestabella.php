...
if (isset($_POST["pilotapontok"])) {
  ...
  while ($sor = mysqli_fetch_assoc($eredmeny7)) {
    ...
    $teljestabella .= "<li class=\"cards_item\">
  ...
  //             <ul>
  //               <li><b>Eddig elért {$pont}:</b> {$sor["pilotapont"]} pont.</li>
  //               <li><b>Csapat:</b> {$sor["csapatnev"]}</li>
  //             </ul>
  //           </div>
  ...
  while ($sor = mysqli_fetch_assoc($eredmeny7)) {
    ...
    $pont = ($sor["csapatpont"] <= '1' ? "pont" : "pontok");
    $teljestabella .= "<li class=\"cards_item\">
          <div class=\"cardd piros\" style=\"border: 5px solid {$borderszin};\">
            <div class=\"card_image\"><img src=\"../kepek/kocsirajzok/{$sor["autofoto"]}\"></div>
            <div class=\"card_content\">
              <h2 class=\"card_title\">{$sor["csapatnev"]}</h2>
              <ul>
                <li><b>Eddig elért {$pont}:</b> {$sor["csapatpont"]} pont.</li>
              </ul>
            </div>
          </div>
        </li>";
  ...
  while ($sor = mysqli_fetch_assoc($eredmeny7)) {
    $pont = ($sor["pilotapont"] <= '1' ? "pont" : "pontok");
    $teljestabella .= "<li class=\"cards_item \">
          <div class=\"cardd piros\">
            <div class=\"card_image\"><img src=\"../kepek/pilotakepek/{$sor["pilotafoto"]}\"></div>
            <div class=\"card_content\">
              <h2 class=\"card_title\">{$sor["pilotaknev"]} {$sor["pilotavnev"]}</h2>
              <ul>
                <li><b>Eddig elért {$pont}:</b> {$sor["pilotapont"]} pont.</li>
...
<body>
  ...
  <div class="main">
    <h1>A 2023-as évad világbajnoki pontverseny állása.</h1> <?php echo $teljestabella; ?>
  </div>
