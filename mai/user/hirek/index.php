...
$sql = "SELECT hirek.id,hirek.tartalom,hirek.letrehozas,hirek.modositas,hirek.leiras, hirek.kulcsszavak,hirek.cim,bejelentkezettek.name, bejelentkezettek.foto
        FROM `hirek` 
...
if(mysqli_num_rows($eredmeny) == 1)
{
            ...
            $sql2 = "SELECT hozzaszolasok.id,hozzaszolasok.hirszoveg,bejelentkezettek.name,bejelentkezettek.foto,hozzaszolasok.hirdatum FROM `hozzaszolasok` inner join hirek on hirek.id = hozzaszolasok.hirid inner join bejelentkezettek on bejelentkezettek.id = hozzaszolasok.accid WHERE hirek.alias = '{$alias}'";
        $eredmeny2 = mysqli_query($dbconn,$sql2);
